package com.example.testcardproject.fragment;
...
import com.example.testcardproject.MainActivity;
import com.example.testcardproject.R;
...
public class CardFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        int type = mCurrentInfo.type;//1:history question or 2::today
        int answer = Integer.valueOf(mCurrentInfo.answer);//option array
        int userOption = 1;
        if(!TextUtils.isEmpty(mCurrentInfo.option)) {
            userOption = Integer.valueOf(mCurrentInfo.option);
        }

        if(type == 1) {// type is 1:means it is a historical question,2 means question of today
